...
for (let i = 0; i < 25; i++){
    ...
    // console.log(`文件读取成功！`)
    fs.appendFileSync ("/AutoControl_test/(x). PS DEV front_platform/PSS-ON-53311_helpInfo.csv", `${JSON.stringify(wirte(data_3.HelpTextConfig[i].lineText))}\n`, err => {
...
// console.log(data.HelpTextConfig[20].lineText.tch_1 + '\n')
// console.log(data.HelpTextConfig[20].lineText.tch_2 + '\n')
// console.log(data.HelpTextConfig[20].lineText.tch_3 + '\n')

// for(let i = 0; i < data.HelpTextConfig.length; i++) {
//     // console.log(data.HelpTextConfig[i].lineText.vie)
//     console.table(data.HelpTextConfig[i].lineText.kor)  // Table
//     // console.log(JSON.stringify(data.HelpTextConfig[i].lineText.sch))  // JSON
// }

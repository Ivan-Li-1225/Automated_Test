...
for (let i = 0; i < 26; i++){
    ...
    // console.log(`文件读取成功！`)
    fs.appendFileSync ("/AutoControl_test/(x). PS DEV front_platform/Console.log Data(PSS-ON-00160)/Raw data/PSS-ON-00160_helpInfo_" + [elem] + ".csv", `${JSON.stringify(wirte(data.HelpTextConfig[i].lineText[elem]))}\n`, err => {

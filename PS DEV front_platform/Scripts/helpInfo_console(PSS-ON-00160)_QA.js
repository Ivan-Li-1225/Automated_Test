const fs = require('fs');
var iconv = require('/Users/milu/node_modules/iconv-lite');
const data = 
{
    "HelpTextConfig": [
        {
        ...
        },
        {
            ...
            "lineText": {
                ...
                "tch": "在新符號掉落後的每一輪旋轉中，上一輪贏分中所涉及的任何銀框符號將被轉換為一個隨機並帶有金框的符號(<BONUS>符號除外)。金框符號上會隨機帶有一個倍數，範圍如下：1000, 500, 200, 100, 50, 30, 20, 14, 9, 7, 5, 4, 3, 2, 1。在新符號掉落後的每一輪旋轉中，上一輪贏分中所涉及的任何金框符號將被轉換為<WILD>符號。",
        ...
        },
        {
            ...
            "page": 5,
            "lineText": {
                "sch": "若在任何旋转期间，赢奖符号若包含金框符号，金框符号上的奖金倍数将累积。在任何旋转期间，带有金框的<WILD>符号都将乘以当前累积奖金倍数。",
                "eng": "DURING ANY SPINS, IF WINNING SYMBOLS INCLUDE GOLD FRAME, THE MULTIPLIER ON THE GOLD FRAMED WILL ACCUMULATE.DURING ANY SPINS,  <WILD> SYMBOL WITH GOLD FRAME WILL BE MULTIPLIED BY THE CURRENT ACCUMULATED MULTIPLIER. ",
                "tai": "ในระหว่างการหมุนเกมทุกครั้ง หากสัญลักษณ์ที่ชนะรางวัล\nมีกรอบทอง ตัวคูณบนสัญลักษณ์กรอบทองนั้นจะถูกสะสมเพิ่มขึ้น\nในระหว่างการหมุนเกมทุกครั้ง สัญลักษณ์ <WILD> ที่มีกรอบทอง\nจะถูกคูณด้วยตัวคูณที่สะสมในปัจจุบัน",
                "ind": "Selama putaran apapun, jika simbol menang termasuk bingkai emas, pengganda pada simbol bingkai emas akan bertambah.Selama putaran apapun, simbol <WILD> dengan bingkai emas akan dikalikan dengan pengganda yang sudah terakumulasi",
                "kor": "어떤 회전이든지, 승리 심볼에 금 프레임이 포함되어 있다면, 금 프레임의 배수가 누적됩니다.어떤 회전이든지, 금 프레임이 있는 <WILD> 심볼은 현재 누적된 배수로 곱해집니다.",
                "vie": "Trong bất kỳ lượt quay nào, nếu các biểu tượng chiến thắng bao gồm khung vàng, bội số trên biểu tượng khung vàng sẽ tích luỹ.Trong bất kỳ lượt quay nào, biểu tượng <WILD> có khung vàng sẽ được nhân với bội số tích luỹ hiện tại.",
                "tch": "若在任何旋轉期間，贏分符號若包含金框符號，金框符號上的贏分倍數將累積。在任何旋轉期間，帶有金框的<WILD>符號都將乘以當前累積贏分倍數。",
                "mys": "Semasa putaran apa pun, jika simbol menang termasuk bingkai emas, pengganda pada simbol bingkai emas akan bertambah.Semasa putaran apa pun, simbol <WILD> dengan bingkai emas akan dikalikan dengan pengganda yang sudah terakumulasi.",
                "jp": "いかなるスピン中でも、勝利のシンボルに金の枠が含まれている場合、金の枠の上の乗数が蓄積されます。いかなるスピン中でも, 金のフレームを持つ<WILD>シンボルは現在の累積乗数で乗算されます。",
                "ru": "Во время любого спина, если выигрышные символы включают в себя золотую рамку, множитель на символе с золотой рамкой будет накапливаться.Во время любого спина, символ <WILD> с золотой рамкой будет умножен на текущий накопленный множитель.",
                "por": "Durante qualquer rodada, se os símbolos vencedores incluírem um quadro dourado, o multiplicador no símbolo com quadro dourado irá acumular.Durante qualquer rodada, o símbolo <WILD> com quadro dourado será multiplicado pelo multiplicador acumulado atual.",
                "esp": "Durante cualquier giro, si los símbolos ganadores incluyen un marco dorado, el multiplicador en el símbolo con marco dorado se acumulará.Durante cualquier giro, el símbolo <WILD> con marco dorado se multiplicará por el multiplicador acumulado actual.",
                "tur": "Herhangi bir spin sırasında, kazanan semboller altın çerçeve içeriyorsa, altın çerçeveli sembol üzerindeki çarpan birikecektir.Herhangi bir spin sırasında, altın çerçeve içeren <WILD> sembolü, mevcut biriken çarpanla çarpılacaktır."
            },
            "position": {
                "x": 360,
                "y": 621
        ...
        },
        {
            ...
            "page": 6,
            "lineText": {
                "sch": "4,5或6个<BONUS>赢得10,12或15个免费游戏。在免費旋转期间，赢奖符号若包含金框符号，金框符号上的奖金倍数将累积，直到免费旋转结束。免费游戏中，4,5或6个<BONUS>可重复赢得5个免费游戏。最大免费游戏数为200。",
                "eng": "4, 5 OR 6 <BONUS> CAN WIN 10,12 OR 15 FREE SPINS.DURING THE FREE SPIN, IF WINNING SYMBOLS INCLUDE GOLD FRAME, THE MULTIPLIER ON THE GOLD FRAME WILL ACCUMULATES UNTIL THE END OF FREE SPIN. 4, 5 OR 6 <BONUS> CAN WIN 5 FREE SPINS DURING BONUS.MAX NUMBER OF FREE SPINS IS 200.",
                ...
                "ind": "4, 5 atau 6 <BONUS> menangkan 10,12 atau 15 permainan gratis.Selama putaran gratis, jika simbol-simbol menang termasuk bingkai emas, pengganda pada bingkai emas akan mengakumulasi hingga akhir putaran gratis.4, 5 atau 6 <BONUS> bisa memenangkan 5 putaran gratis selama bonus.Jumlah permainan gratis paling banyak adalah 200.",
                "kor": "4, 5 또는 6 개의 <BONUS> 는 10개 ,12개 또는 15 개의 프리 게임을 획득할 수 있습니다 프리 스핀 중에는 금 프레임을 포함한 이기는 심볼이 있으면 금 프레임의 배수가 프리 스핀 종료까지 누적됩니다.4, 5 또는 6 <BONUS> 보너스 도중 5 회 무료 스핀을 획득할 수 있습니다 최대 프리 게임수는 200",
                "vie": "4, 5 hoặc 6 <BONUS> giành được 10 , 12 hoặc 15 trò chơi miễn phí.Trong lượt quay miễn phí, nếu các ký hiệu chiến thắng bao gồm khung vàng, bội số trên khung vàng sẽ tích luỹ cho đến khi kết thúc lượt quay miễn phí.4, 5 hoặc 6 <BONUS> trở lên có thể thắng 5 vòng quay miễn phí trong trò chơi trúng thưởng.Số trò chơi miễn phí lớn nhất là 200.",
                "tch": "4、5 或 6個 <BONUS> 贏得 10、12 或 15 個免費遊戲。在免費旋轉期間，贏分符號若包含金框符號，金框符號上的贏分倍數將累積，直到免費旋轉結束。免費遊戲中，4、5 或 6個 <BONUS>可重複贏得5個免費遊戲。最大免費遊戲數為200。",
                "mys": "4, 5 atau 6 <BONUS> boleh memenangi 10, 12 atau 15 putaran percuma.Semasa putaran bebas, jika simbol kemenangan termasuk bingkai emas, pengganda pada bingkai emas akan terkumpul sehingga akhir putaran bebas.4, 5 atau 6 <BONUS> boleh memenangi 5 putaran percuma semasa bonus.Bilangan putaran percuma maksimum adalah 200.",
                "jp": "<BONUS> 4、5 または 6個で、無料ゲームを 10個、12個または15個獲得できる。フリースピン中には、勝利シンボルにゴールドフレームが含まれている場合、ゴールドフレームの乗数はフリースピンの終了まで蓄積されます。ボーナスゲームでは、4,5,6個の＜BONUS＞で、5 回のフリーゲームを獲得することができます無料ゲームの数は最大200個。",
                "ru": "4, 5 или 6 <BONUS> могут выиграть 10 ,12 или 15 фриспинов.Во время бесплатного вращения, если выигрышные символы включают в себя золотую рамку, множитель на золотой рамке будет накапливаться до конца бесплатного вращения.В бонусной игре 4, 5 и 6 <BONUS> могут выиграть 5 фриспинов.Макс Фриспинов 200 .",
                "por": "4, 5 ou 6 <BONUS> podem ganhar 10, 12 ou 15 giros grátis.Durante a rodada grátis, se os símbolos vencedores incluírem uma moldura dourada, o multiplicador na moldura dourada acumulará até o final da rodada grátis.4, 5 ou 6 <BONUS> podem ganhar 5 giros grátis durante o bônus.O número máximo de giros grátis é 200.",
                "esp": "4, 5 o 6 símbolos <BONUS> pueden ganar 10, 12 o 15 giros gratis.Durante la tirada gratuita, si los símbolos ganadores incluyen un marco dorado, el multiplicador en el marco dorado se acumulará hasta el final de la tirada gratuita.En los juegos gratuitos, 4, 5 o 6 símbolos <BONUS> pueden ganar 5 juegos gratuitos adicionales.El número máximo de juegos gratuitos es de 200.",
                "tur": "4, 5 veya 6 <BONUS>, sirasiyla 10, 12 veya 15 ücretsiz dönüş kazanabilir.Ücretsiz dönem sırasında, kazanan semboller altın çerçeve içeriyorsa, altın çerçeve üzerindeki çarpan ücretsiz dönemin sonuna kadar birikecektir.Ücretsiz oyunlar sirasinda, 4, 5 veya 6 <BONUS>, 5 ücretsiz oyunu tekrar kazanabilir.En fazla ücretsiz dönüş sayisi 200'dür."
            },
            "position": {
                "x": 360,
                "y": 879
        ...
        },
        {
            ...
            "lineText": {
                ...
                "eng": "APART FROM THE SILVER FRAME AND GOLD FRAME,AFTER THE PAYOUT OF EVERY ROUND IS MADE, ALL WINNING SYMBOLS WILL EXPLODE ALLOWING THE REELS GENERATE NEW RESULTS TO INITIATE A NEW ROUND OF SPINNING. WHENEVER THE SILVER FRAME OR GOLD FRAME IS CONNECTED, THE SYMBOLS WILL UNDERGO A TRANSFORMATION. ADDITIONAL WINNING COMBINATION WILL BE TALLIED IN EVERY ROUND UNTIL NO MORE WINNING COMBINATION CAN BE TALLIED. SOME SYMBOLS IN REELS 2, 3, 4, 5 AND6 MAY OCCUPY 2 SYMBOLS' SPACES AND EACH OF THESE SYMBOLS WILL REPRESENT AS A SINGLE SYMBOL DURING PAYOUT CALCULATIONS.",
...
let language_box = ['eng', 'esp' , 'ind', 'jp', 'kor', 'mys', 'por', 'ru', 'sch', 'tai', 'tch', 'tur', 'vie']
for (let i = 0; i < 26; i++){

    language_box.forEach(elem => {
        // console.log(elem);
    ...
    // console.log(`文件读取成功！`)
    fs.appendFileSync ("D:/AutomotiveTest_QA/DEV_platform Test/Console_log/PSS-ON-00160(熊熊戰爭)/Raw data/PSS-ON-00160_helpInfo_" + [elem] + ".csv", `${JSON.stringify(wirte(data.HelpTextConfig[i].lineText[elem]))}\n`, err => {
